...
# trusted objects
from ezodf2.xmlns import etree, CN, wrap
from ezodf2.tablerowcontroller import TableCellAccessor
from ezodf2.tableutils import iter_cell_range

# object to test
from ezodf2.cellspancontroller import CellSpanController

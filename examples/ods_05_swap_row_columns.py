...
doc = ezodf2.newdoc(doctype="ods", filename="my_spreadsheet.ods")
# create a new table
table = ezodf2.Table(name="Table", size=(ROWS, COLS))
...
symtable = ezodf2.Table(name="Symmetry", size=(COLS, ROWS))
doc.sheets += symtable
...
# alternative way
symtable= ezodf2.Table(name="Symmetry(2)", size=(COLS, ROWS))
doc.sheets += symtable
